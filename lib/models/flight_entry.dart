class FlightEntry {
  ...
  /// Display label for the flight counter, e.g. "#212" or "#212 - #213" when
  /// this entry groups several identical flights. [sourceNumber] always
  /// holds the starting flight number as a plain integer string.
